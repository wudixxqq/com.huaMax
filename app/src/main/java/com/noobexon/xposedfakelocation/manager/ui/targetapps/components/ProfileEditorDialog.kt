...
fun ProfileEditorDialog(
    ...
    val globalLabel = stringResource(R.string.profile_global)
    val customLabel = stringResource(R.string.profile_custom)

    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text(stringResource(R.string.profile_edit_title, appLabel)) },
        text = {
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                ToggleRow(stringResource(R.string.profile_enabled), enabled) { enabled = it }
                ...
                BooleanSettingItem(
                    ...
                    description = stringResource(R.string.profile_advanced_description),
